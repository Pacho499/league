...
const Champions: React.FC = () => {
      ...
      .map((value: string, index: number) => {
        ...
        return (
          <Link
            key={index}
            to={`/champions/${url}`}
            className='champSearch d-flex flex-column text-center text-white col col-xs-1 col-md-2 col-lg-1 px-3'
          >
            <img
              className='my-3'
              id='champRotationImg'
  ...
  return (
    <div>
      ...
      <div
        className={
          loading ? '' : 'd-flex row justify-content-center mx-auto mt-5 w-100'
        }
      >
        {error ? <Errors /> : null}
